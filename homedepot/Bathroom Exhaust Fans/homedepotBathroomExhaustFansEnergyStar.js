...
async.eachSeries(typeArr, function(typeItem, bigCallback){
	...
	async.eachSeries(currentWattageArr, function(currentWattage, callback) {
		...
		page = "http://www.homedepot.com/b/ENERGY-STAR-Certified/Fan-Only/N-5yc1vZ1z0tlzwZ1z0yi0z/Ntk-All/Ntt-bathroom%2Bexhaust%2Bfan?Ntx=mode%20matchall&NCNI-5&Ns=P_REP_PRC_MODE%7C0";
	...
	var filename = "homedepotBathroomExhuastFanseEnergyStar.csv";
  	csv()
	.from(csvString)
	.to('./' + filename)
	.on('end', function() {
