...
async.eachSeries(typeArr, function(typeItem, bigCallback){
	...
	async.eachSeries(currentWattageArr, function(currentWattage, callback) {
		...
		page = "http://www.homedepot.com/b/Decor-Holiday-Decorations-Christmas-Lights/LED/N-5yc1vZc3tbZ1z11erc/Ntk-All/Ntt-holiday%2Blights?Ntx=mode%20matchall&NCNI-5&Ns=P_REP_PRC_MODE%7C0";
	...
	var filename = "homedepotHolidayLightsLED.csv";
  	csv()
	.from(csvString)
	.to('./' + filename)
	.on('end', function() {
